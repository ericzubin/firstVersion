...
public class Registro extends Activity {
	...
	public static final String NOMBRE_ID = "nombre";
	EditText nombreET;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!TextUtils.isEmpty(registrationId)) {
			Intent i = new Intent(applicationContext, Inicio.class);  /// Usuarios.class  GreetingActivity.class);
	...
	public void RegisterUser(View view) {
		...
		String nombreID = nombreET.getText().toString();
